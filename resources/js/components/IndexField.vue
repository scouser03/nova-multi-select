<template>
    <div>
        <div v-if="data.length" class="flex items-center space-2 ml-3">
            <div v-for="item in data" :key="item.id" style="background-color:#4099de" class="relative group overflow-hidden px-2 py-1 rounded-lg flex space-x-2 items-center mr-2">
