...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-multi-select', __webpack_require__(6));
  Vue.component('detail-multi-select', __webpack_require__(14));
  Vue.component('form-multi-select', __webpack_require__(17));
});
...
var update = __webpack_require__(1)("1500bfa0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e63f81a\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e63f81a\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("de2e08b0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e63f81a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./IndexField.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9e63f81a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./IndexField.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
    ...
    methods: {
        remove: function remove(item) {
            ...
            Nova.request().post('/nova-vendor/scouser03/multi-select/delete', {
                ...
                _this.data = _this.data.filter(function (mapItem) {
                    return mapItem !== item;
                });
                _this.$toasted.show(item[_this.name] + ' has been deleted', {
                    type: 'success'
                });
            });
        },
        updated: function updated() {
            ...
            var ids = this.value.map(function (obj) {
                return obj[_this2.inputId];
            });

            Nova.request().post('/nova-vendor/scouser03/multi-select/update', {
                attribute: this.field.attribute,
                id: this.resource.id.value,
                ids: ids,
                resourceName: this.resourceName
            }).then(function (response) {
                _this2.data = _this2.value;
                _this2.closeHandler();
                _this2.$toasted.show('updated!', {
                    type: 'success'
                });
            });
        },
        ...
        removeSomeClass: function removeSomeClass() {
            var tbl = document.querySelector(['table']).parentElement;
            tbl.classList.remove('overflow-hidden');
            tbl.classList.remove('overflow-x-auto');
        },
        addSomeClass: function addSomeClass() {
            var tbl = document.querySelector(['table']).parentElement;
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex items-center" }, [
    _vm.select == false && _vm.field.indexUpdateable
      ? _c(
          "button",
          {
            staticClass:
              "inline-flex cursor-pointer text-70 hover:text-primary mr-2",
    ...
    _vm.data.length
      ? _c(
          "div",
          {
            ...
            staticClass: "flex items-center space-2 w-56 overflow-x-scroll\t",
          ...
          _vm._l(_vm.data, function(item) {
            return _c(
              "div",
              {
                key: item.id,
                staticClass:
                  "multi-select-field-container relative w-fit px-2 py-1 rounded-lg flex space-x-2 items-center mr-2",
                staticStyle: { "background-color": "#4099de" }
              },
              [
                _c("span", { staticClass: "relative btn text-white" }, [
                  _vm._v(_vm._s(item[_vm.name]))
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "flex items-center" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "h-4 w-4 ml-2 font-bold cursor-pointer hover:text-white",
                      attrs: {
                        xmlns: "http://www.w3.org/2000/svg",
                        viewBox: "0 0 20 20",
                        fill: "currentColor"
    ...
    _vm.select
      ? _c(
          "div",
          { staticClass: "cursor-pointer", on: { click: _vm.updated } },
          [
            _c(
              "svg",
              {
    ...
    methods: {
        remove: function remove(item) {
            ...
            Nova.request().post('/nova-vendor/scouser03/multi-select/delete', {
                ...
                _this.$toasted.show(item[_this.name] + ' has been deleted', { type: "success" });
            });
        }
    }
});
        ...
        _vm._t("value", function() {
          return [
            ...
            _vm.data.length
              ? _c(
                  "div",
                  { staticClass: "flex items-center space-2" },
                  _vm._l(_vm.data, function(item, index) {
                    return _c(
                      "div",
                      {
                        key: item.id,
                        staticClass:
                          "relative group overflow-hidden px-2 py-1 rounded-lg flex items-center mr-2",
                        staticStyle: { "background-color": "#4099de" }
                      },
                      [
                        _c("span", { staticClass: "relative btn text-white" }, [
