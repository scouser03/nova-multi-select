...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-multi-select', __webpack_require__(3));
  Vue.component('detail-multi-select', __webpack_require__(6));
  Vue.component('form-multi-select', __webpack_require__(9));
});
    ...
    methods: {
        remove: function remove(item) {
            ...
            Nova.request().post('/nova-vendor/scouser03/multi-select/delete', {
                ...
                _this.$toasted.show(item.tag + ' has been deleted', { type: "success" });
            });
        }
    }
});
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "flex items-center space-2 ml-3" },
      _vm._l(_vm.data, function(item) {
        return _c(
          "div",
          {
            key: item.id,
            staticClass:
              "relative group overflow-hidden p-2 rounded-lg flex space-x-2 items-center mr-2",
          ...
          [
            ...
            _c("div", { staticClass: "flex items-center" }, [
              _c(
                "svg",
                {
                  staticClass: "h-5 w-5 ml-2 cursor-pointer hover:text-white",
                  attrs: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(22);
